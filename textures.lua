...
local C = {
    ...
    T_WHITE = 31, T_ORANGE = 32, T_MAGENTA = 33, T_LIGHT_BLUE = 34,
    T_YELLOW = 35, T_LIME = 36, T_PINK = 37, T_GRAY = 38,
    T_LIGHT_GRAY = 39, T_CYAN = 40, T_PURPLE = 41, T_BLUE = 42,
    T_BROWN = 43, T_GREEN = 44, T_RED = 45, T_BLACK = 46,

    -- Wood Types (6)
    WOAK = 47, WBIRCH = 48, WSPRUCE = 49, WJUNGLE = 50, WACACIA = 51, WDARKOAK = 52,

    -- Ore Colors (4)
    O_COAL = 53, O_IRON = 54, O_GOLD = 55, O_DIAMOND = 56,
...
textures.sand = {
    {C.SAND2, C.SAND2, C.SAND1, C.SAND2, C.SAND2, C.SAND1, C.SAND2, C.SAND2},
    {C.SAND2, C.SAND1, C.SAND2, C.SAND2, C.SAND1, C.SAND2, C.SAND2, C.SAND1},
    {C.SAND1, C.SAND2, C.SAND2, C.SAND1, C.SAND2, C.SAND2, C.SAND1, C.SAND2},
    {C.SAND2, C.SAND2, C.SAND1, C.SAND2, C.SAND2, C.SAND1, C.SAND2, C.SAND2},
    {C.SAND2, C.SAND1, C.SAND2, C.SAND2, C.SAND1, C.SAND2, C.SAND2, C.SAND1},
    {C.SAND1, C.SAND2, C.SAND2, C.SAND1, C.SAND2, C.SAND2, C.SAND1, C.SAND2},
    {C.SAND2, C.SAND2, C.SAND1, C.SAND2, C.SAND2, C.SAND1, C.SAND2, C.SAND2},
...
textures.sandstone = {
    {C.SAND1, C.SAND1, C.SAND2, C.SAND1, C.SAND1, C.SAND2, C.SAND1, C.SAND1},
    {C.SAND1, C.SAND2, C.SAND1, C.SAND1, C.SAND2, C.SAND1, C.SAND1, C.SAND2},
    {C.SAND2, C.SAND1, C.SAND1, C.SAND2, C.SAND1, C.SAND1, C.SAND2, C.SAND1},
    {C.SAND1, C.SAND1, C.SAND2, C.SAND1, C.SAND1, C.SAND2, C.SAND1, C.SAND1},
    {C.SAND1, C.SAND2, C.SAND1, C.SAND1, C.SAND2, C.SAND1, C.SAND1, C.SAND2},
    {C.SAND2, C.SAND1, C.SAND1, C.SAND2, C.SAND1, C.SAND1, C.SAND2, C.SAND1},
    {C.SAND1, C.SAND1, C.SAND2, C.SAND1, C.SAND1, C.SAND2, C.SAND1, C.SAND1},
...
textures.red_sand = {
    {C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2},
    {C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1},
    {C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2},
    {C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1},
    {C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2},
    {C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1, C.RSAND2, C.RSAND1},
